...
....
A természetben rendszeres formák jelenek és tapasztolhatók meg .
Az élő  természeti dolgok mint például kolibri vagy a páva tollainak mintázat olyan absztrakt minta elemeket jelenítenek  meg a minta rendszerben , ennek a célja hogy elmagyarázzák felfedezék a mintáknak a rendszerességét .
Természeti mintákkal kapcsolataban az embereknek vannak  velűlk élményei  olyan téren hogy számukra lehet stimuláló vagy nyugtató egy adót minta 
Környezetben olyan minta fajták jelenek meg amik a fraktálok közé tartoznak , ezek olyan minta elemek ismétlődnek különböző mértékben , példáil ezek körében tartoznak fák ők is természetes fraktálok hogy sok szorositják magukat és hogy az erdő és természet létrehozza a biológiai sokféleséget .
Természetes részek közé azokat a természeti elemeket hatásokat mondjuk mint például foltok , csíkok fodrok elágazás repedések törések és a nővéyek is ebe a körbe tartozik.
Természet néha mutat nekeünk egy olyan kautikus képet mutatót nekünk , amit néha elég nehéz értelmezni pedig ebben a kautikus képben valamelyest rejlik egy matematikai rend .
Miután elkezdik ezeket vizsgálni egyre jobban rájönnek hogy káosz mögött létezik egy rendszer is 
Mik azok a természeti minták a természeti minták azok amik egy rendszerességi formákban láthatók .
Ezek a minták külömböző konteksztusokban ismétlődnek és néha matematikailag ábrázolták ezeket .
Természetes minták közé tartozik szimetriák , fák , spirálok , repedések , csikok .
A természetes formák erdeti formát öltenek a természetben kagylok levelek madarak , természet által inspirálodott művészet külömbőzö elemeket emeli ki .
E téren létre hozott műalkotások nyilatkozatott tesz a természet és az emberiség felé .
...
\section{A természet a kortás művészetben}

\subsection{Polgár Csaba}
Polgár Csaba egy olyan textilművész volt aki nagyon szerette a modern művészetet , korszerűséget mindig komolyan vette a munkái során .
A munkáiban szerette meg mutatni a szabadság érzeteket .
Kifejlesztett egy olyan technikát amit fényfestésnek nevezett vagy fakításnak , ez a technika igazából a fotogramnak a fordítottja és a készitési folyamat röviden úgy néz ki  hogy ha a festett anyag kikerül a napra akkor veszít a színéből , kitakarásokkal lehet szabályozni a hogy hol fakítson jobban ezzel külömbözö mintákat létre hozva és a kékre festett anyagra dróthálókat  teker és rács szerű mintákat fakít ki belőle .
Volt egy híres program ami itthon az Ő nevéhez fűződik és nem más volt mint a Quasi kékfestő program ebben a programban nem  kékfestő minta dúcokal állitoták elö a mintákat hanem szitával készítették el ezeket a mintákat a kék anyagokra.
  Ezt  a technikát alkalmazva teszi lehetővé új textilkarakter létre hozását de még megmaradva a múltbeli technikáknál 

\subsection{Horváth Hanga } 
Horvát Hanga japánban  élő textilművész munkái során azzal foglalkozott hogy kutattta a hagyományos japán  kékfetsési technikát a shiborit 
A munkái során tanulmányozta a novényi festési technikát itt leginkább a z indigóval való festészett , színezést lehetőségeit vizsgálta .
Fogalakozott még mag a termesztési folyamtokal is de ezeket a tapasztalazokat tanulmányi utja során Tokusimában volt lehetsősége meg tapasztalni 

\subsection{Tóvaj Rozália}
Mestermunkája során azzal foglalkozott hogy újra  szerette volna gondolni a hagyományos kékfestő hagyományt.
 A célja a gazadag kulturkincs és a mintarendszer tovább vitele a jelenkori technologiával .
 A végső eredmény az volt hogy a hagyományos mintákat 3D nyomtatásal készitette el lágy anygokra 
...
Ezt az egészet úgy fogalmaznám meg hogy az eddig féléves munkám során valahogy a természetnél lyukadtam ki de mért pont a természetnél azt még az elején magam se tudtam de ahogy elkezdtem a vizsgálni és kutatni a dolgokat ebben a témában kapcsoltban és találatam egy olyan pontot ebben a témában nagyon is érdekelt és ez az érdeklődési irány a külünböző termésű fa fajták  felé vitt és e fafajták közül hármat választottam .
 Próbáltam olyan természeti elemeket keresni, amik a minden napi köztudatban  benne vannak és ezeket  a természeti formákat mindenki ismeri és találkozót vele  és felhasználta ezeket valamiyen formában . 
 Ezek a termési elemek a dió , makk és a gesztenye volt .
 És ezekkel a terméseket szeretném egy újabb  , modernebb irányban vinni ahol ezek a természeti elemek más arculatban , könnyed vonal rencerel de mégis felismerhető minta ként jelenjenke meg az emberi szem elött .
...
Ezt követően a Hollandok sajátították ki maguknak a mert elkezdték nagyobb mennyiségben szállítani az indigót köszönhetően a modernebb és fejlettebb hajó flottáiknak. Ennek következményeként tönkre ment az Európai csülleng termelés. A legjelentősebb mennyiség gyártást Indiában kezdték el 1600 évek végén sok indigót hoztak be Európa.
...
Néhány vidéki városban a 19 század idején az ottani igényeket figyelembe véve készítették el a  termékeket  legyen a kár szó lakástextilről v
...
\textit{Németország} 
Itt három technológia volt elterjedve a Tartalék (Reservedruck), közvetlen (Direktdruck), maratás (Ätzdruck). Az alap textilt először fehérítették, szárították és végül hengerelve (Mangeln) vasalták és keményítették.
...
Minták olyan irányban fejlődtek tovább hogy nem csak már említett egyszerűbb minták voltak hanem  elkezdtek más művészeti területekről mintákat beemelni és azokat is tovább fejleszteni.
...
A szakdolgozat írása közben kutatómunkám során megismert minta kincsek új inspirációt és irányt adtak saját minta készletem kibővítésére mint például: 
